...
let value :any; console.log(value);
value = "abc"; console.log(value);
value = 123;console.log(value);
value = true;console.log(value);
value = null;console.log(value);
value = undefined;console.log(value);
value = [];console.log(value);
value = {};console.log(value);
value = Math.random(); console.log(value);
...
let myvalue: unknown;
myvalue = true; console.log(myvalue);
myvalue = 445; console.log(myvalue);
myvalue = "hii"; console.log(myvalue);
myvalue = null; console.log(myvalue);
myvalue = undefined; console.log(myvalue);
myvalue = []; console.log(myvalue);
myvalue = {}; console.log(myvalue);
myvalue = Math.random(); console.log(myvalue); 
myvalue = () => {console.log("hi again.");
};
console.log(myvalue);
...
let wall : unknown; //undefine
console.log(wall);

const vall : unknown = "wall";
console.log(vall); // unddefine

const vall2 : any = wall;
...
function handleUnknown(params:unknown):void {
...
type Toy = "Ball" | "Doll" | "Block";

function handleToy(toy: Toy) {
    switch (toy) {
        case "Ball":
